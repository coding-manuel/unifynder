  ...
  return (
    <Layout>
      ...
      >
        ...
        <DialogActions>
          <Button variant="text" onClick={dhandleClose}>
            Cancel
          </Button>
              ...
              >
                <Stack gap={1}>
                  <Typography gutterBottom variant="h6" sx={{ margin: 0 }}>
                    {uniData.College_Name}
                  </Typography>
                  <Rating
                    name="rating"
                    value={uniData.Rating}
                    precision={0.5}
                    readOnly
                  />
            ...
            <Stack direction="column" gap={2}>
              <Stack direction="row" alignItems="center" gap={2}>
                <Stack direction="row" gap={2}>
                  ...
                  <Typography variant="subtitle2" color="text.secondary">
                    {uniData.Total_Students} Seats
                  </Typography>
                </Stack>
                <Stack direction="row" gap={2}>
                  <FeatherIcon size={18} icon="briefcase" />
                  <Typography variant="subtitle2" color="text.secondary">
                    {uniData.Total_Faculty} Faculty Members
                  </Typography>
                </Stack>
                <Stack direction="row" gap={2}>
                  <FeatherIcon size={18} icon="calendar" />
                  <Typography variant="subtitle2" color="text.secondary">
                    Established in {uniData.Established_Year}
                  </Typography>
                </Stack>
              </Stack>
              <Stack>
                <Stack direction="row" alignItems="center" gap={1}>
                  ...
                  <Typography variant="subtitle2" color="text.secondary">
                    ₹{Math.floor(uniData.Average_Fees).toLocaleString("en-IN")}
                  </Typography>
                </Stack>
              </Stack>
            </Stack>
                  ...
                  >
                    ...
                    {admin && (
                      <Tooltip title="Delete Comment">
                        <IconButton onClick={() => dhandleClickOpen(index)}>
                          <FeatherIcon size={16} icon="trash" />
                        </IconButton>
                      </Tooltip>
                    )}
                  </Stack>
